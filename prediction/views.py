...
def index(request):
    ...
    if form:
        ...
        print(df)
        model = joblib.load('E:\Omkar\Projects\Machine Learning\Student_Career_Prediction\prediction\static\svm.pkl')
        labelencoder = joblib.load('E:\Omkar\Projects\Machine Learning\Student_Career_Prediction\prediction\static\label.pkl')
